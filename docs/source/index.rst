.. py-keycloak documentation master file, created by
...
.. image:: https://readthedocs.org/projects/py-keycloak/badge/?version=latest
    :target: http://py-keycloak.readthedocs.io/en/latest/?badge=latest


Welcome to py-keycloak's documentation!
===========================================
...
`https://github.com/c0mpiler/py-keycloak/issues <https://github.com/c0mpiler/py-keycloak/issues>`_

Documentation
==================

The documentation for py-keycloak is available on `readthedocs <http://py-keycloak.readthedocs.io>`_.
